  ...
  return (
    <div className="login">
      ...
      <div className="col" id='right'>
        <div className="image">
          {/* <img src="https://aimint.org/ap/wp-content/uploads/sites/18/2016/04/image-placeholder-vertical.jpg" alt="bgimage"  /> */}
    ...
    // <div className='App'>
    //   <form onSubmit={submitHandler}>
    //     Email: <input value={emailId} onChange={handleEmailId} type="email" /><br />
